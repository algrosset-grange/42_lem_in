...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/05/06 06:02:43 by agrosset          #+#    #+#             */
/*   Updated: 2017/05/06 06:05:18 by agrosset         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_parse_flags(t_printf *p)
{
	short	n;
...
** 6) the second call to ft_parse_flags is to handle undefined behaviors.
*/

void		ft_parse_optionals(t_printf *p)
{
	p->f = 0;
	p->min_length = 0;
	p->precision = 1;
	...
	while (1)
	{
		if (*p->format == 'h' && p->f < F_SHORT2 && p->f < F_SHORT)
